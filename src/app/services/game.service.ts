...
export class GameService {
  #properties: PropertyCell[] = [
    ...
    { id: 4, name: "Hyderabad", price: 340, rent: 38, tier: PropertyTier.Premium, color: PropertyColors.Orange },
    { id: 5, name: "Chennai", price: 320, rent: 36, tier: PropertyTier.Premium, color: PropertyColors.Orange },
    { id: 6, name: "Kolkata", price: 310, rent: 34, tier: PropertyTier.Premium, color: PropertyColors.Orange },
    ...
    { id: 13, name: "Indore", price: 240, rent: 24, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    { id: 14, name: "Bhopal", price: 230, rent: 23, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    { id: 15, name: "Visakhapatnam", price: 220, rent: 22, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    ...
    { id: 22, name: "Raipur", price: 150, rent: 15, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    { id: 23, name: "Kochi", price: 140, rent: 14, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    { id: 24, name: "Coimbatore", price: 130, rent: 13, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    ...
    { id: 31, name: "Agra", price: 75, rent: 7, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    { id: 32, name: "Varanasi", price: 70, rent: 7, tier: PropertyTier.Basic, color: PropertyColors.Orange },
    { id: 33, name: "Nashik", price: 65, rent: 6, tier: PropertyTier.Basic, color: PropertyColors.Orange },
